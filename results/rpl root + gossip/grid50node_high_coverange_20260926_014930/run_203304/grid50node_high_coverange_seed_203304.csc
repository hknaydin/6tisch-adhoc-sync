 ...
 * border-router-server (ID=6) + 50x border-router-client (ID=1..51, 6 haric)
 * 
...
while (1) {
  ...
  <plugin>
    Mobility
    <plugin_config>
      <positions EXPORT="copy">[APPS_DIR]/mobility/grid50node_high.dat</positions>
    </plugin_config>
    <width>500</width>
    <z>2</z>
    <height>234</height>
