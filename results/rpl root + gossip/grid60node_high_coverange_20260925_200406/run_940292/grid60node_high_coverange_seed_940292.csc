 ...
 * border-router-server (ID=7) + 60x border-router-client (ID=1..61, 7 haric)
 * 
...
while (1) {
  ...
  <plugin>
    Mobility
    <plugin_config>
      <positions EXPORT="copy">[APPS_DIR]/mobility/grid60node_high.dat</positions>
    </plugin_config>
    <width>500</width>
    <z>2</z>
    <height>234</height>
